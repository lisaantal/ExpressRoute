...
#[derive(Debug)]
pub struct ExpressRouteProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ExpressRouteProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ExpressRoute processing");
    
    let mut processor = ExpressRouteProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ExpressRouteProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ExpressRouteProcessor::new(false);
